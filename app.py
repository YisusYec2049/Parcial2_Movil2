...
app.register_blueprint(driver_blueprint, url_prefix = '/api')    
app.register_blueprint(user_blueprint, url_prefix = '/api')
app.register_blueprint(passenger_blueprint, url_prefix = '/api')
...
app.register_blueprint(request_status_blueprint, url_prefix = '/api')
app.register_blueprint(request_trip_blueprint, url_prefix = '/api')
app.register_blueprint(trip_has_report_blueprint, url_prefix = '/api')
